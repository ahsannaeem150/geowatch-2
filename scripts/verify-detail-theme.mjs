...
const INCIDENT_ID = '4f3e3ac6-f1c1-4afb-8bac-d6f33ec0133d';
...
async function main() {
  ...
  await page.goto(`${USER_BASE}/incident/${INCIDENT_ID}`, { waitUntil: 'networkidle' });

  await setTheme(page, 'light');
  await page.reload({ waitUntil: 'networkidle' });
  await screenshot(page, 'detail-light.png');

  await setTheme(page, 'dark');
  await page.reload({ waitUntil: 'networkidle' });
  await screenshot(page, 'detail-dark.png');
