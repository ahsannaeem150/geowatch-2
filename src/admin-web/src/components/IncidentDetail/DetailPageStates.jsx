...
/**
 * Loading/error states for the admin-web full detail pages
 * (/incident/:id, /zone/:id). Loading mirrors the page's hero + body shape;
 * error mirrors the tui-state card pattern from the directory pages.
 */
