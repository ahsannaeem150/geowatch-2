 ...
 * visible map rectangle inside user-web's map viewport.
 *
...
export function computeMapPadding({
  ...
  // --admin-ps-chips-height (38) in index.css; the right panel starts below
  // the same offset, and the map fit must account for it too.
  ...
  // The right detail panel is rendered as an absolute overlay that slides
