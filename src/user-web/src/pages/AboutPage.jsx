  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '64px 24px' }}>
      ...
      <p style={{ fontSize: '16px', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '24px' }}>
        ...
        events as they unfold. From border clashes to diplomatic developments, protests to
      ...
      <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '16px' }}>
        ...
        monitoring, satellite imagery analysis, and on-the-ground partner networks. Every event
      ...
      <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7, marginBottom: '16px' }}>
        GeoWatch currently monitors events across six categories: Conflict, Protest, Disaster,
      ...
      <p style={{ fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
        Each event is assigned a severity score from 1 (Minimal) to 5 (Critical) based on
