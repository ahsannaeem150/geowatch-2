          ...
          return (
            <NavLink
              ...
              style={{
                ...
                textDecoration: 'none',
                color: isActive ? 'var(--sa-accent-light)' : 'var(--text-secondary)',
                background: isActive ? 'var(--sa-accent-glow)' : 'transparent',
                border: isActive ? '1px solid var(--sa-accent-strong)' : '1px solid transparent',
                fontSize: 14,
                fontWeight: 500,
