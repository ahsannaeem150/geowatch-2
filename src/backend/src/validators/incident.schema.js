...
export const listIncidentsQuerySchema = z.object({
  ...
  zoneCategoryId: z.coerce.number().int().positive().optional(),
  zoneCategoryIds: optionalNumberArray,
...
export const searchIncidentsQuerySchema = z.object({
  ...
  sort: z.enum(['relevance', 'newest', 'oldest', 'severity_asc', 'severity_desc', 'name_asc', 'name_desc', 'area_asc', 'area_desc']).optional().default('relevance'),
